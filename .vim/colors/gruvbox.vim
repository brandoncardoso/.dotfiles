...
if &background == "dark"
	...
	let s:gb.dark0  = ['fdf4c1', 231]
	let s:gb.dark1  = ['ebdbb2', 223]
	let s:gb.dark2  = ['d5c4a1', 187]
	let s:gb.dark3  = ['bdae93', 144]
	let s:gb.dark4  = ['a89984', 138]

	let s:gb.medium = ['928374', 102]

	let s:gb.light0 = ['282828', 233]
	let s:gb.light1 = ['3c3836', 235]
	let s:gb.light2 = ['504945', 237]
	let s:gb.light3 = ['665c54', 239]
	let s:gb.light4 = ['7c6f64', 241]

	let s:gb.red    = ['9d0006', 124]
	let s:gb.orange = ['af3a03', 130]
	let s:gb.yellow = ['b57614', 136]
	let s:gb.green  = ['79740e', 100]
	let s:gb.aqua   = ['427b58', 65]
	let s:gb.blue   = ['076678', 24]
	let s:gb.purple = ['8f3f71', 95]
endif
